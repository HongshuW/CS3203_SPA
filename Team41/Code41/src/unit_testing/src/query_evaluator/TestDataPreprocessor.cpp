...
TEST_CASE("Test Data Preprocessor") {
  ...
  shared_ptr<DummyDataRetriever> dummyDataRetriever =
      make_shared<DummyDataRetriever>(pkbStorage);
  /*
   * procedure p1 {
   * 1 dummyVarA = 1;
   ...
   */
  SECTION(
      "Test dummy retriever 1: assign a1, a2, get table such that follows(a1, "
      "a2)") {
  ...
  SECTION(
      "Test dummy retriever 1: assign a; print p, get table such that "
      "follows(a, p)") {
    shared_ptr<vector<Declaration>> declarations =
        make_shared<vector<Declaration>>();
    shared_ptr<QE::DataPreprocessor> dataPreprocessor =
  ...
  SECTION(
      "Test dummy retriever 1: assign a, a2, get table such that followsT(_, "
      "a2)") {
    shared_ptr<vector<Declaration>> declarations =
        make_shared<vector<Declaration>>();
    shared_ptr<QE::DataPreprocessor> dataPreprocessor =
    ...
    Table expected =
        TestQE::TableBuilder().setHeaders({"a2"})->addRow({"2"})->build();
    REQUIRE(actual.isEqual(expected) == true);
  }
  SECTION(
      "Test dummy retriever 1: assign a; print p, get table such that "
  ...
  SECTION(
      "Test dummy retriever 1: assign a;  get table such that followsT(a, _)") {
    shared_ptr<vector<Declaration>> declarations =
        make_shared<vector<Declaration>>();
    shared_ptr<QE::DataPreprocessor> dataPreprocessor =
        make_shared<QE::DataPreprocessor>(dummyDataRetriever, declarations);
  ...
  SECTION(
      "Test dummy retriever 1: assign a;  get table such that followsT(a, 3)") {
    shared_ptr<vector<Declaration>> declarations =
        make_shared<vector<Declaration>>();
    shared_ptr<QE::DataPreprocessor> dataPreprocessor =
        make_shared<QE::DataPreprocessor>(dummyDataRetriever, declarations);
  ...
  SECTION(
      "Test dummy retriever 1: assign a, a2, get table such that followsT(1, "
      "a2)") {
    shared_ptr<vector<Declaration>> declarations =
        make_shared<vector<Declaration>>();
    shared_ptr<QE::DataPreprocessor> dataPreprocessor =
  ...
  SECTION(
      "Test dummy retriever 1: assign a; variable v, get table such that "
      "Modifies(a, v)") {
    shared_ptr<vector<Declaration>> declarations =
        make_shared<vector<Declaration>>();
    shared_ptr<QE::DataPreprocessor> dataPreprocessor =
  ...
  SECTION(
      "Test dummy retriever 1: assign a;  get table such that Modifies(a, "
      "'dummyVarA')") {
    shared_ptr<vector<Declaration>> declarations =
        make_shared<vector<Declaration>>();
    shared_ptr<QE::DataPreprocessor> dataPreprocessor =
    ...
    Table expected =
        TestQE::TableBuilder().setHeaders({"a"})->addRow({"1"})->build();
    REQUIRE(actual.isEqual(expected) == true);
  }
  SECTION(
      "Test dummy retriever 1: assign a; variable v, get table such that "
  ...
  shared_ptr<DummyDataRetriever2> dummyDataRetriever2 =
      make_shared<DummyDataRetriever2>(pkbStorage2);

  SECTION(
      "Test dummy retriever 2: assign a1, a2, get table such that follows(a1, "
      "a2)") {
    shared_ptr<vector<Declaration>> declarations =
        make_shared<vector<Declaration>>();
    Synonym syn1 = Synonym("a1");
  ...
  SECTION(
      "Test dummy retriever 2: while w, get table such that followsT(1, w)") {
    shared_ptr<vector<Declaration>> declarations_2 =
        make_shared<vector<Declaration>>();
  ...
  SECTION(
      "Test dummy retriever 2: assign a, get table such that Parent(_, a)") {
    shared_ptr<vector<Declaration>> declarations_3 =
        make_shared<vector<Declaration>>();
  ...
  SECTION(
      "Test dummy retriever 2: assign a, get table such that Uses(a, 'y')") {
    shared_ptr<vector<Declaration>> declarations_4 =
        make_shared<vector<Declaration>>();
