...
shared_ptr<TestQueryBuilder> TestQueryBuilder::addDeclaration(
...
shared_ptr<TestQueryBuilder> TestQueryBuilder::addModifiesS(Ref arg1,
                                                            Ref arg2) {
  this->suchThatClauses->push_back(make_shared<ModifiesSClause>(arg1, arg2));
  return shared_from_this();
}

shared_ptr<TestQueryBuilder> TestQueryBuilder::addModifiesP(Ref arg1,
                                                            Ref arg2) {
...
shared_ptr<TestQueryBuilder> TestQueryBuilder::addWith(WithRef arg1,
                                                       WithRef arg2) {
  this->withClauses->push_back(make_shared<WithClause>(arg1, arg2));
  return shared_from_this();
}

shared_ptr<TestQueryBuilder> TestQueryBuilder::addAssignPattern(
    Synonym arg1, Ref arg2, ExpressionSpec arg3) {
  this->patternClauses->push_back(
      make_shared<AssignPatternClause>(arg1, arg2, arg3));
  return shared_from_this();
}

shared_ptr<TestQueryBuilder> TestQueryBuilder::addIfPattern(Synonym arg1,
                                                            Ref arg2) {
  this->patternClauses->push_back(make_shared<IfPatternClause>(arg1, arg2));
  return shared_from_this();
}

shared_ptr<TestQueryBuilder> TestQueryBuilder::addWhilePattern(Synonym arg1,
                                                               Ref arg2) {
