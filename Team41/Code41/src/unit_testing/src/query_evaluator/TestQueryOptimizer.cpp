...
TEST_CASE("Test query optimizer") {
  SECTION("Test building query optimizer with three groups") {
    ...
    shared_ptr<SuchThatClause> suchThatClause1 =
        make_shared<ModifiesSClause>(Synonym("s1"), Synonym("v1"));
    shared_ptr<SuchThatClause> suchThatClause2 =
        make_shared<ModifiesSClause>(Synonym("s2"), Synonym("v1"));

    shared_ptr<SuchThatClause> suchThatClause3 =
        make_shared<ModifiesSClause>(Synonym("s3"), Synonym("v2"));
    shared_ptr<SuchThatClause> suchThatClause4 =
        make_shared<ModifiesSClause>(Underscore(), Synonym("v2"));
    ...
    shared_ptr<QE::QueryOptimizer> queryOptimizer =
        make_shared<QE::QueryOptimizer>(query);
  ...
  SECTION("Test building query optimizer with no syn clauses") {
    ...
    shared_ptr<SuchThatClause> suchThatClause1 =
        make_shared<ModifiesSClause>(Synonym("s1"), Synonym("v1"));
    shared_ptr<SuchThatClause> suchThatClause2 =
        make_shared<UsesSClause>(Synonym("s2"), Synonym("v1"));

    shared_ptr<SuchThatClause> suchThatClause3 =
        make_shared<FollowsClause>(Synonym("s3"), Synonym("s4"));
    shared_ptr<SuchThatClause> suchThatClause4 =
        make_shared<FollowsTClause>(Underscore(), Synonym("s3"));

    shared_ptr<SuchThatClause> suchThatClause5 =
        make_shared<ModifiesSClause>(Underscore(), Ident("haha1"));
    shared_ptr<SuchThatClause> suchThatClause6 =
        make_shared<ModifiesSClause>(Ident("haha2"), Underscore());
  ...
  SECTION(
      "Test building query optimizer with no syn clauses and different clause "
      "types") {
    shared_ptr<Query> query = make_shared<Query>();

    shared_ptr<SuchThatClause> suchThatClause1 =
        make_shared<ModifiesSClause>(Synonym("s1"), Synonym("v1"));
    shared_ptr<WithClause> withClause1 = make_shared<WithClause>(
        AttrRef(Synonym("s2"), QB::AttrName::STMT_NUMBER),
        AttrRef(Synonym("v1"), QB::AttrName::VAR_NAME));

    shared_ptr<SuchThatClause> suchThatClause3 =
        make_shared<FollowsClause>(Synonym("s3"), Synonym("s4"));
    shared_ptr<PatternClause> patternClause1 =
        make_shared<AssignPatternClause>(Synonym("s3"), Underscore());
  ...
  SECTION("Test building query optimizer sorting with two groups") {
    ...
    shared_ptr<SuchThatClause> suchThatClause1 =
        make_shared<ModifiesSClause>(Synonym("s1"), Synonym("v1"));
    shared_ptr<SuchThatClause> suchThatClause2 =
        make_shared<UsesSClause>(Underscore(), Synonym("v1"));
    shared_ptr<SuchThatClause> suchThatClause3 =
        make_shared<FollowsClause>(Synonym("s1"), Synonym("s4"));
    shared_ptr<SuchThatClause> suchThatClause4 =
        make_shared<FollowsTClause>(Underscore(), Synonym("s3"));
    shared_ptr<SuchThatClause> suchThatClause5 =
        make_shared<FollowsTClause>(Synonym("s5"), Synonym("s3"));
    shared_ptr<SuchThatClause> suchThatClause6 =
        make_shared<ModifiesPClause>(Underscore(), Synonym("v1"));
    shared_ptr<SuchThatClause> suchThatClause7 =
        make_shared<FollowsTClause>(Synonym("s4"), Synonym("s5"));
