...
TEST_CASE("Test Next Relation Extractor") {
  SECTION("Test Empty Procedure") {
    ...
    auto actual = static_pointer_cast<RelationResult>(nextExtractor.extract())
                      ->getResult();
  ...
  SECTION("Test Procedure With If Statements") {
    shared_ptr<PKBStorage> pkbStorage = make_shared<PKBStorage>();
  ...
  SECTION("Test Procedure With While Statements") {
    shared_ptr<PKBStorage> pkbStorage = make_shared<PKBStorage>();
  ...
  SECTION("Test Procedure With Nested If Statements In While Loop") {
    shared_ptr<PKBStorage> pkbStorage = make_shared<PKBStorage>();
