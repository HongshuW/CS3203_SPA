...
shared_ptr<ProgramNode> InvalidProcedureDummies::getTestProgramNode(int idx) {
  ...
  vector<shared_ptr<StmtNode>> statementList_p1 =
      vector<shared_ptr<StmtNode>>({calls_p1, print_p1, read_p1});
  auto procedure1_p1 =
      make_shared<ProcedureNode>("procedure1", statementList_p1);
  auto program1 = make_shared<ProgramNode>(
      vector<shared_ptr<ProcedureNode>>({procedure1_p1}));
  ...
  vector<shared_ptr<StmtNode>> statementList_p2 =
      vector<shared_ptr<StmtNode>>({calls_p2});
  auto procedure1_p2 =
      make_shared<ProcedureNode>("procedure2", statementList_p2);
  auto program2 = make_shared<ProgramNode>(
      vector<shared_ptr<ProcedureNode>>({procedure1_p2}));
  ...
  shared_ptr<ProcedureNode> procedure_3 =
      make_shared<ProcedureNode>(ProcedureNode(
          "procedure3", {printNode_p3, readNode_p3, ifNode_p3, readNode3_p3}));
  shared_ptr<ProgramNode> program3 =
      make_shared<ProgramNode>(ProgramNode({procedure_3}));
  ...
  vector<shared_ptr<StmtNode>> statementList_p4 =
      vector<shared_ptr<StmtNode>>({make_shared<CallNode>("procedure2")});
  vector<shared_ptr<StmtNode>> elseStatementList_p4 =
  ...
  shared_ptr<CondExprNode> ifCondExpr_p4 = make_shared<CondExprNode>(
      make_shared<RelExprNode>(make_shared<ExprNode>("bar"), "==", rhs_p4));
  auto if_p4 = make_shared<IfNode>(ifCondExpr_p4, statementList_p4,
                                   elseStatementList_p4);
  vector<shared_ptr<StmtNode>> procedure1_stmtList =
      vector<shared_ptr<StmtNode>>({read_p4, read2_p4, if_p4});
  auto procedure1_p4 =
      make_shared<ProcedureNode>("procedure1", procedure1_stmtList);
  ...
  auto while_p4 = make_shared<WhileNode>(
      ifCondExpr_p4,
      vector<shared_ptr<StmtNode>>({read3_p4, call2_p4, call3_p4}));
  vector<shared_ptr<StmtNode>> procedure2_stmtList =
      vector<shared_ptr<StmtNode>>({while_p4});
  auto procedure2_p4 =
      make_shared<ProcedureNode>("procedure2", procedure2_stmtList);
  ...
  shared_ptr<StmtNode> assignNode_p4 =
      make_shared<AssignNode>(make_shared<VariableNode>("x"), exprNode_p4);
  vector<shared_ptr<StmtNode>> procedure3_stmtList =
      vector<shared_ptr<StmtNode>>({assignNode_p4});
  auto procedure3_p4 =
      make_shared<ProcedureNode>("procedure3", procedure3_stmtList);

  auto call4_p4 = make_shared<CallNode>("procedure1");
  vector<shared_ptr<StmtNode>> procedure4_stmtList =
      vector<shared_ptr<StmtNode>>({call4_p4});
  auto procedure4_p4 =
      make_shared<ProcedureNode>("procedure4", procedure4_stmtList);

  vector<shared_ptr<ProcedureNode>> program4_stmtList =
      vector<shared_ptr<ProcedureNode>>(
          {procedure1_p4, procedure2_p4, procedure3_p4, procedure4_p4});
  ...
  vector<shared_ptr<StmtNode>> stmtList_p5 =
      vector<shared_ptr<StmtNode>>({call_p5});
  auto procedure1_p5 = make_shared<ProcedureNode>("procedure1", stmtList_p5);

  auto call2_p5 = make_shared<CallNode>("procedure1");
  vector<shared_ptr<StmtNode>> stmtList2_p5 =
      vector<shared_ptr<StmtNode>>({call2_p5});
  auto procedure2_p5 = make_shared<ProcedureNode>("procedure2", stmtList2_p5);

  vector<shared_ptr<ProcedureNode>> program5_stmtList =
      vector<shared_ptr<ProcedureNode>>({procedure1_p5, procedure2_p5});
  ...
  vector<shared_ptr<StmtNode>> stmtList_p6 =
      vector<shared_ptr<StmtNode>>({call_p6});
  ...
  vector<shared_ptr<StmtNode>> stmtList2_p6 =
      vector<shared_ptr<StmtNode>>({read_p6});
  auto procedure2_p6 = make_shared<ProcedureNode>("procedurE2", stmtList2_p6);

  vector<shared_ptr<ProcedureNode>> program6_stmtList =
      vector<shared_ptr<ProcedureNode>>({procedure1_p6, procedure2_p6});
  ...
  vector<shared_ptr<StmtNode>> stmtList1_p7 =
      vector<shared_ptr<StmtNode>>({read_p7});
  auto procedure1_p7 =
      make_shared<ProcedureNode>("duplicateProcedure", stmtList1_p7);

  auto x2_p7 = make_shared<VariableNode>("y");
  auto read2_p7 = make_shared<ReadNode>(x2_p7);
  vector<shared_ptr<StmtNode>> stmtList2_p7 =
      vector<shared_ptr<StmtNode>>({read2_p7});
  auto procedure2_p7 =
      make_shared<ProcedureNode>("duplicateProcedure", stmtList2_p7);

  vector<shared_ptr<ProcedureNode>> program7_stmtList =
      vector<shared_ptr<ProcedureNode>>({procedure1_p7, procedure2_p7});
  auto program7 = make_shared<ProgramNode>(program7_stmtList);

  vector<shared_ptr<ProgramNode>> programNodes =
      vector<shared_ptr<ProgramNode>>{program1, program2, program3, program4,
