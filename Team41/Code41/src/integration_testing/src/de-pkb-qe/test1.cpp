...
TEST_CASE("Test de-pkb-qe integration") {
  ...
  SECTION(
      "stmt s; select s such that affect(1000, s)  from procedure 12: out of "
      "range") {
    shared_ptr<PKBStorage> pkb = make_shared<PKBStorage>();
    shared_ptr<DataModifier> dataModifier = make_shared<DataModifier>(pkb);
    auto pNode =
  ...
  SECTION(
      "stmt s; select s such that affect(s, 1000)  from procedure 12: out of "
      "range") {
    shared_ptr<PKBStorage> pkb = make_shared<PKBStorage>();
    shared_ptr<DataModifier> dataModifier = make_shared<DataModifier>(pkb);
    auto pNode =
  ...
  SECTION(
      "stmt s; select s such that affect(s, 9)  from procedure 12: in range "
      "boundary value") {
    shared_ptr<PKBStorage> pkb = make_shared<PKBStorage>();
    shared_ptr<DataModifier> dataModifier = make_shared<DataModifier>(pkb);
    auto pNode =
  ...
  SECTION(
      "stmt s; select s such that affect(s, 10)  from procedure 12: out of "
  ...
  SECTION(
      "stmt s; select s such that affect(s, 10)  from procedure 12: in range "
      "boundary value") {
    shared_ptr<PKBStorage> pkb = make_shared<PKBStorage>();
    shared_ptr<DataModifier> dataModifier = make_shared<DataModifier>(pkb);
    auto pNode =
  ...
  SECTION(
      "stmt s; select s such that affect*(1000, 1000)  from procedure 12: in "
      "range boundary value") {
    shared_ptr<PKBStorage> pkb = make_shared<PKBStorage>();
    shared_ptr<DataModifier> dataModifier = make_shared<DataModifier>(pkb);
    auto pNode =
  ...
  SECTION(
      "stmt s; select s such that next*(s, 1000)  from procedure 12: in range "
      "boundary value") {
    shared_ptr<PKBStorage> pkb = make_shared<PKBStorage>();
    shared_ptr<DataModifier> dataModifier = make_shared<DataModifier>(pkb);
    auto pNode =
  ...
  SECTION(
      "stmt s; select s such that next*(1000, 1000)  from procedure 12: in "
      "range boundary value") {
    shared_ptr<PKBStorage> pkb = make_shared<PKBStorage>();
    shared_ptr<DataModifier> dataModifier = make_shared<DataModifier>(pkb);
    auto pNode =
  ...
  SECTION(
      "stmt s; select s such that next*(1000, 7)  from procedure 12: in range "
      "boundary value") {
    shared_ptr<PKBStorage> pkb = make_shared<PKBStorage>();
    shared_ptr<DataModifier> dataModifier = make_shared<DataModifier>(pkb);
    auto pNode =
