...
TEST_CASE("Test Query Builder Integration") {
  ...
  SECTION("assign a; Select a pattern a (_, _) and pattern a (_, \"x + 1\")") {
    std::string queryStr =
        "assign a; Select a pattern a (_, _) and a (_, \"x + 1\")";
    auto queryBuilder = QueryBuilder();
    auto query = queryBuilder.buildPQLQuery(queryStr);
    REQUIRE(query->declarations->size() == 1);
    REQUIRE(*(query->declarations) == std::vector<Declaration>{Declaration(
  ...
  SECTION("assign a; variable x;  Select a pattern a (_, \"x + 1\")") {
    std::string queryStr =
        "assign a; variable x; Select a pattern a (_, \"x + 1\")";
    auto queryBuilder = QueryBuilder();
    auto query = queryBuilder.buildPQLQuery(queryStr);
    REQUIRE(query->declarations->size() == 2);
    REQUIRE(*(query->declarations) ==
  ...
  SECTION("assign a; variable x; Select a pattern a (_, _\"(x + 1) * 3\"_)") {
    std::string queryStr =
        "assign a; variable x; Select a pattern a (_, _\"(x + 1) * 3\"_)";
    auto queryBuilder = QueryBuilder();
    auto query = queryBuilder.buildPQLQuery(queryStr);
    REQUIRE(query->declarations->size() == 2);
    REQUIRE(*(query->declarations) ==
  ...
  SECTION("variable v; Select v such that Calls (_, \"testProcedure\")") {
    std::string queryStr =
        "variable v; Select v such that Calls (_, \"testProcedure\")";
    auto queryBuilder = QueryBuilder();
    auto query = queryBuilder.buildPQLQuery(queryStr);
    REQUIRE(query->declarations->size() == 1);
    REQUIRE(*(query->declarations) ==
  ...
  SECTION("Select BOOLEAN such that Next* (2, 9) and Next (9, 10)") {
    std::string queryStr =
        "Select BOOLEAN such that Next* (2, 9) and Next (9, 10)";
    auto queryBuilder = QueryBuilder();
    auto query = queryBuilder.buildPQLQuery(queryStr);
    REQUIRE(*(query->selectClause) == SelectClause(ReturnType::BOOLEAN));
  ...
  SECTION("procedure p; variable v; Select p with p.procName = \"test\"") {
    std::string queryStr =
        "procedure p; variable v; Select p with p.procName = \"test\"";
    auto queryBuilder = QueryBuilder();
    auto query = queryBuilder.buildPQLQuery(queryStr);
    REQUIRE(query->declarations->size() == 2);
    REQUIRE(*(query->declarations) ==
  ...
  SECTION(
      ...
      "c.value") {
    std::string queryStr =
        "stmt BOOLEAN; constant c; Select BOOLEAN with BOOLEAN.stmt# = c.value";
    auto queryBuilder = QueryBuilder();
    auto query = queryBuilder.buildPQLQuery(queryStr);
    REQUIRE(query->declarations->size() == 2);
    REQUIRE(*(query->declarations) ==
  ...
  SECTION("Invalid 'and' connector, throw PQLParseException") {
    std::string queryStr =
        "if i; Select BOOLEAN such that Follows (9, 10) and pattern i (2, _, "
        "_)";
    auto queryBuilder = QueryBuilder();
    REQUIRE_THROWS_AS(queryBuilder.buildPQLQuery(queryStr), PQLParseException);
  }
  ...
  SECTION("Invalid pattern clause, throw PQLParseException") {
    std::string queryStr =
        "assign a; stmt s; variable v; Select s pattern Modifies(s, v)";
    auto queryBuilder = QueryBuilder();
    REQUIRE_THROWS_AS(queryBuilder.buildPQLQuery(queryStr), PQLParseException);
  }
  ...
  SECTION("Negative number - stmt BOOLEAN; Select BOOLEAN with 123 = -123") {
    ...
    REQUIRE_THROWS_AS(queryBuilder.buildPQLQuery(queryStr),
                      PQLTokenizeException);
  }

  SECTION(
      "Syntactically valid query but semantically invalid"
      "stmt s; read r; print p; variable v; Select s such that Follows(r, p) "
      "pattern a(v, _\"100\"_)") {
    std::string queryStr =
  ...
  SECTION(
      "Invalid query, no error should be thrown"
      "variable v; assign a; Select v such that Uses(a,v) pattern "
      "a(_,_\"2\"_)") {
    std::string queryStr =
        "variable v; assign a; Select v such that Uses(a,v) pattern "
        "a(_,_\"2\"_)";
  ...
  SECTION(
      "Syntactically valid query but semantically invalid"
      "variable v; procedure p; Select v such that Uses(a,v) pattern v(p, _, "
      "_)") {
    std::string queryStr =
        "variable v; procedure p; Select v such that Uses(a,v) pattern v(p, _, "
        "_)";
  ...
  SECTION(
      ...
      "variable v; assign a; Select v such that Uses(a,v) pattern a(_,_\"+ "
      "2\"_)") {
    std::string queryStr =
        "variable v; assign a; Select v such that Uses(a,v) pattern a(_,_\"+ "
        "2\"_)";
  ...
  SECTION(
      "Syntactically invalid query"
      "variable v; procedure p; Select v such that Uses(a,v) pattern v(p, "
      "_\"\"_)") {
    std::string queryStr =
        "variable v; procedure p; Select v such that Uses(a,v) pattern v(p, "
        "_\"\"_)";
  ...
  SECTION(
      "Wrong usage of and to connect pattern clause and such that clause - "
      "Syntax Error") {
    std::string queryStr =
        "assign a; while w; Select a such that Parent* (w, a) pattern a "
        "(\"x\", _) and Next* (1, a)";
    auto queryBuilder = QueryBuilder();
    REQUIRE_THROWS_AS(queryBuilder.buildPQLQuery(queryStr), PQLParseException);
  }
  ...
  SECTION(
      "Test wrong first arg RefType in Follows Clause, first arg cannot be "
      "Ident") {
  ...
  SECTION(
      "Test wrong second arg RefType in Follows Clause, first second cannot be "
      "Ident") {
  ...
  SECTION(
      "Test wrong second arg RefType in Follows* Clause, second arg cannot be "
      "Ident") {
  ...
  SECTION(
      "Test wrong first arg RefType in Parent Clause, first arg cannot be "
      "Ident") {
  ...
  SECTION(
      "Test wrong second arg RefType in Parent Clause, second arg cannot be "
      "Ident") {
  ...
  SECTION(
      "Test wrong second arg RefType in Uses_S Clause (first arg is Integer), "
  ...
  SECTION(
      "Test wrong second arg RefType in Uses_S Clause (first arg is "
  ...
  SECTION(
      "Test wrong second arg RefType in Uses_P Clause (first arg is Ident), "
      "second arg cannot be Integer") {
  ...
  SECTION(
      "Test wrong second arg RefType in Uses_P Clause (first arg is procedure "
      "synonym), "
      "second arg cannot be Integer") {
  ...
  SECTION(
      "Test wrong first arg RefType in Calls Clause, first arg cannot be "
      "Integer") {
  ...
  SECTION(
      "Test wrong second arg RefType in Calls* Clause, second arg cannot be "
      "Integer") {
  ...
  SECTION(
      "Test wrong first arg RefType in Next Clause, first arg cannot be "
      "Ident") {
  ...
  SECTION(
      "Test wrong first arg RefType in Affects Clause, first arg cannot be "
      "Ident") {
  ...
  SECTION(
      "Test wrong second arg RefType in Affects* Clause, second arg cannot be "
      "Ident") {
