...
TEST_CASE("Test SP Integration") {
  SECTION(
      ...
      "statements") {
    string source_1 =
        "../../../src/integration_testing/src/sp/follows_source/source1.txt";
  ...
  SECTION(
      ...
      "statements") {
    string source_2 =
        "../../../src/integration_testing/src/sp/follows_source/source2.txt";
    ASTBuilder astBuilder = ASTBuilder();
  ...
  SECTION(
      ...
      "statement") {
    string source_3 =
        "../../../src/integration_testing/src/sp/follows_source/source3.txt";
    ASTBuilder astBuilder = ASTBuilder();
  ...
  SECTION(
    ...
    string source_4 =
        "../../../src/integration_testing/src/sp/follows_source/source4.txt";
    ASTBuilder astBuilder = ASTBuilder();
  ...
  SECTION(
      ...
      "statement") {
    string source_5 =
        "../../../src/integration_testing/src/sp/follows_source/source5.txt";
    ASTBuilder astBuilder = ASTBuilder();
  ...
  SECTION(
      ...
      "level of nesting") {
    string source_6 =
        "../../../src/integration_testing/src/sp/follows_source/source6.txt";
    ASTBuilder astBuilder = ASTBuilder();
  ...
  SECTION(
      ...
      "level of nesting") {
    string source_7 =
        "../../../src/integration_testing/src/sp/follows_source/source7.txt";
    ASTBuilder astBuilder = ASTBuilder();
  ...
  SECTION(
      ...
      "statements") {
    string source_1 =
        "../../../src/integration_testing/src/sp/modifies_source/source1.txt";
    ASTBuilder astBuilder = ASTBuilder();
    shared_ptr<ProgramNode> root = astBuilder.buildAST(source_1);
  ...
  SECTION(
      ...
      "multiple statements") {
    string source_2 =
        "../../../src/integration_testing/src/sp/modifies_source/source2.txt";
    ASTBuilder astBuilder = ASTBuilder();
    shared_ptr<ProgramNode> root = astBuilder.buildAST(source_2);
  ...
  SECTION(
      ...
      "statements") {
    string source_3 =
        "../../../src/integration_testing/src/sp/modifies_source/source3.txt";
    ASTBuilder astBuilder = ASTBuilder();
    shared_ptr<ProgramNode> root = astBuilder.buildAST(source_3);
  ...
  SECTION(
      ...
      "statements") {
    string source_1 =
        "../../../src/integration_testing/src/sp/parent_source/source1.txt";
    ASTBuilder astBuilder = ASTBuilder();
    shared_ptr<ProgramNode> root = astBuilder.buildAST(source_1);
  ...
  SECTION(
      ...
      "statements") {
    string source_2 =
        "../../../src/integration_testing/src/sp/parent_source/source2.txt";
    ASTBuilder astBuilder = ASTBuilder();
    shared_ptr<ProgramNode> root = astBuilder.buildAST(source_2);
  ...
  SECTION(
      ...
      "statements") {
    string source_3 =
        "../../../src/integration_testing/src/sp/parent_source/source3.txt";
    ASTBuilder astBuilder = ASTBuilder();
    shared_ptr<ProgramNode> root = astBuilder.buildAST(source_3);
  ...
  SECTION(
      ...
      "statements") {
    string source_1 =
        "../../../src/integration_testing/src/sp/uses_source/source1.txt";
    ASTBuilder astBuilder = ASTBuilder();
    shared_ptr<ProgramNode> root = astBuilder.buildAST(source_1);
  ...
  SECTION(
      ...
      "statements") {
    string source_2 =
        "../../../src/integration_testing/src/sp/uses_source/source2.txt";
    ASTBuilder astBuilder = ASTBuilder();
    shared_ptr<ProgramNode> root = astBuilder.buildAST(source_2);
  ...
  SECTION(
      ...
      "statements") {
    string source_3 =
        "../../../src/integration_testing/src/sp/uses_source/source3.txt";
    ASTBuilder astBuilder = ASTBuilder();
    shared_ptr<ProgramNode> root = astBuilder.buildAST(source_3);
  ...
  SECTION("Test Parser + Call Extraction -> deep nested source program") {
    string source_1 =
        "../../../src/integration_testing/src/sp/calls_source/source1.txt";
    ASTBuilder astBuilder = ASTBuilder();
    shared_ptr<ProgramNode> root = astBuilder.buildAST(source_1);
  ...
  SECTION("Test Parser + Conditional Pattern Extraction -> all variable same") {
    string source_1 =
        "../../../src/integration_testing/src/sp/conditional_pattern_source/"
        "source1.txt";
    ASTBuilder astBuilder = ASTBuilder();
    shared_ptr<ProgramNode> root = astBuilder.buildAST(source_1);
