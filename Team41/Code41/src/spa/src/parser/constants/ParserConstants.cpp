...
const string ParserConstants::SP_PARSE_EXCEPTION_EXPECT_COMPARATOR_OP =
    "Expected a comparator operator in conditional expression";
const string ParserConstants::SP_PARSE_EXCEPTION_INVALID_PROC_NAME =
    "Invalid procedure name: ";
const string ParserConstants::SP_PARSE_EXCEPTION_EMPTY_STMT_LIST =
    "Statement list cannot be empty.";
const string ParserConstants::SP_PARSE_EXCEPTION_EXPECT_COND_EXPRESSION =
    "conditional expression";
const string ParserConstants::SP_PARSE_EXCEPTION_EXPECT_VARIABLE_NAME =
    "variable name";
const string ParserConstants::SP_PARSE_EXCEPTION_ASSIGN_STMT_RHS_EMPTY =
    "The RHS of assign statement cannot be empty";
const string ParserConstants::SP_PARSE_EXCEPTION_EMPTY_PROCEDURE =
    "No procedure found.";
const string ParserConstants::SP_PARSE_EXCEPTION_INVALID_TOKEN_EXPR =
    "Invalid Token found for expression";
}  // namespace SourceParser