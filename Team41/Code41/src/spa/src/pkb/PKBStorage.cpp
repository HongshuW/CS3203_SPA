...
shared_ptr<VariableTable> PKBStorage::getVariables() { return variableTable; }

shared_ptr<ConstantTable> PKBStorage::getConstants() { return constantTable; }
...
shared_ptr<FollowsTable> PKBStorage::getFollows() { return followsTable; }

shared_ptr<FollowsTable> PKBStorage::getFollowsT() { return followsTTable; }

shared_ptr<ParentTable> PKBStorage::getParent() { return parentTable; }

shared_ptr<ParentTable> PKBStorage::getParentT() { return parentTTable; }

shared_ptr<UsesTable> PKBStorage::getUsesS() { return usesSTable; }

shared_ptr<UsesTable> PKBStorage::getUsesP() { return usesPTable; }

shared_ptr<ModifiesTable> PKBStorage::getModifiesS() { return modifiesSTable; }

shared_ptr<ModifiesTable> PKBStorage::getModifiesP() { return modifiesPTable; }

shared_ptr<Table> PKBStorage::getCalls() {
  return callsTable->getCallsProcedures();
}

shared_ptr<CallsTable> PKBStorage::getCallsT() { return callsTTable; }

shared_ptr<Table> PKBStorage::getCallsProcedureNames() {
  return callsTable->getStmtNoProcMap();
}

shared_ptr<NextTable> PKBStorage::getNext() { return nextTable; }

shared_ptr<NextTable> PKBStorage::getNextT() { return nextTTable; }
...
void PKBStorage::saveNext(vector<string> next) { nextTable->appendRow(next); }
...
shared_ptr<Table> PKBStorage::getMatchedAssignPatterns(
...
shared_ptr<PatternTable> PKBStorage::getIfPatterns() { return ifPatternTable; }

void PKBStorage::saveAssignPattern(vector<string> metainfo,
