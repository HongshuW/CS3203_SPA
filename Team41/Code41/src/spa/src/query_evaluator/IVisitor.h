...
class IVisitor {
 public:
  ...
  virtual shared_ptr<Table> visit(
      shared_ptr<QB::SelectClause> selectClause) = 0;
  virtual shared_ptr<Table> visit(
      shared_ptr<QB::IfPatternClause> ifPatternClause) = 0;
  virtual shared_ptr<Table> visit(
  ...
  virtual shared_ptr<Table> visit(
      shared_ptr<QB::FollowsClause> followsClause) = 0;
  virtual shared_ptr<Table> visit(
      shared_ptr<QB::FollowsTClause> followsTClause) = 0;
  virtual shared_ptr<Table> visit(
      shared_ptr<QB::ParentClause> parentClause) = 0;
  virtual shared_ptr<Table> visit(
      shared_ptr<QB::ParentTClause> parentTClause) = 0;
  ...
  virtual shared_ptr<Table> visit(
      shared_ptr<QB::ModifiesSClause> modifiesSClause) = 0;
  virtual shared_ptr<Table> visit(
      shared_ptr<QB::ModifiesPClause> modifiesPClause) = 0;
  virtual shared_ptr<Table> visit(shared_ptr<QB::CallsClause> callsClause) = 0;
  virtual shared_ptr<Table> visit(
      shared_ptr<QB::CallsTClause> callsTClause) = 0;
  ...
  virtual shared_ptr<Table> visit(
      shared_ptr<QB::AffectsClause> affectsClause) = 0;
  virtual shared_ptr<Table> visit(
      shared_ptr<QB::AffectsTClause> affectsTClause) = 0;
};
