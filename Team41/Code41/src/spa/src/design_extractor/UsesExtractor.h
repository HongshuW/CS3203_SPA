...
class UsesExtractor {
 public:
  static shared_ptr<list<vector<string>>> extractUsesS(
      shared_ptr<ProgramNode> rootPtr);
  static shared_ptr<list<vector<string>>> extractUsesP(
      shared_ptr<ProgramNode> rootPtr);

 private:
  static unordered_set<string> extractUsesSHelper(
  ...
  static void insertCallsInIfAndWhileForUseS(
      shared_ptr<ProgramNode> rootPtr, shared_ptr<list<vector<string>>> ans);

  static void insertCallsForUseS(shared_ptr<ProgramNode> rootPtr,
