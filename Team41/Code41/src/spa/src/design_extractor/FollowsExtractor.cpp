...
shared_ptr<list<vector<string>>> FollowsExtractor::extractFollows(
    shared_ptr<ProgramNode> programNode) {
  vector<vector<shared_ptr<StmtNode>>> listOfStmtList =
      getListOfStmtList(programNode);
...
shared_ptr<list<vector<string>>> FollowsExtractor::extractFollowsStar(
    shared_ptr<AST::ProgramNode> programNode) {
  vector<vector<shared_ptr<StmtNode>>> listOfStmtList =
      getListOfStmtList(programNode);
  shared_ptr<unordered_map<shared_ptr<StmtNode>, int>> nodeToLineNoMap =
      ASTUtils::getNodePtrToLineNumMap(programNode);
...
vector<vector<shared_ptr<StmtNode>>> FollowsExtractor::getListOfStmtList(
    shared_ptr<ProgramNode> programNode) {
  vector<vector<shared_ptr<StmtNode>>> listOfStmtList;
...
void FollowsExtractor::saveFollowsToOutput(
    vector<shared_ptr<StmtNode>> stmtList, list<vector<string>> *output,
    shared_ptr<unordered_map<shared_ptr<StmtNode>, int>> nodeToLineNoMap) {
...
void FollowsExtractor::saveFollowsStarToOutput(
    vector<shared_ptr<StmtNode>> stmtList, list<vector<string>> *output,
    shared_ptr<unordered_map<shared_ptr<StmtNode>, int>> nodeToLineNoMap) {
  vector<int> stmtNoList;
  if (stmtList.size() <= 1) {
