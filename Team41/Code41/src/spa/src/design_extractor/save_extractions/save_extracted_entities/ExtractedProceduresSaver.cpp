...
void ExtractedProceduresSaver::save(shared_ptr<ProgramNode> programNode, shared_ptr<DataModifier> dataModifier) {
    shared_ptr<unordered_set<string>> set = EntityExtractor::extractAllProcedures(programNode);
