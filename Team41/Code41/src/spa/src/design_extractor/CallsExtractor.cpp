...
shared_ptr<list<vector<string>>> CallsExtractor::extractCalls(
    shared_ptr<ProgramNode> programNode) {
  list<vector<string>> output;
  auto mappedCallNodesToProcedures =
      EntityExtractor::extractCallNodesFromProcedures(programNode);
...
shared_ptr<list<vector<string>>> CallsExtractor::extractCallsStar(
    shared_ptr<ProgramNode> programNode) {
  list<vector<string>> output;
  auto mappedCallNodesToProcedures =
      EntityExtractor::extractCallNodesFromProcedures(programNode);
...
void CallsExtractor::extractCallStmtRelationshipsToOutput(
...
void CallsExtractor::extractCallStmtRelationshipsWithIfAndWhileToOutput(
