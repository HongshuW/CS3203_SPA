...
shared_ptr<map<int, vector<int>>> ParentExtractor::extractParentHashmap(
...
void ParentExtractor::extractParentTDFS(
...
shared_ptr<list<vector<string>>> ParentExtractor::extractParent(
    shared_ptr<ProgramNode> rootPtr) {
...
shared_ptr<list<vector<string>>> ParentExtractor::extractParentT(
