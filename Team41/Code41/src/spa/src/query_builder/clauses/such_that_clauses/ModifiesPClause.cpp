...
ModifiesPClause::ModifiesPClause(Ref arg1, Ref arg2) : SuchThatClause(std::move(arg1), std::move(arg2)) {}
...
Table ModifiesPClause::accept(shared_ptr<IVisitor> visitor) {
    return visitor->visit(shared_from_this());
}

pair<unordered_set<DesignEntity>, unordered_set<DesignEntity>> ModifiesPClause::getAllowedArgsSynonym() {
