...
NextClause::NextClause(Ref arg1, Ref arg2) : SuchThatClause(std::move(arg1), std::move(arg2)) {}
...
pair<unordered_set<DesignEntity>, unordered_set<DesignEntity>> NextClause::getAllowedArgsSynonym() {
