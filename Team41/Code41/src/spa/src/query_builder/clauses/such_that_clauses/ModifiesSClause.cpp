...
ModifiesSClause::ModifiesSClause(Ref arg1, Ref arg2)
...
shared_ptr<Table> ModifiesSClause::accept(shared_ptr<IVisitor> visitor) {
  return visitor->visit(shared_from_this());
}

pair<unordered_set<DesignEntity>, unordered_set<DesignEntity>>
ModifiesSClause::getAllowedArgsSynonym() {
